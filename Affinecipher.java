...
public class Affinecipher
{
	...
	// Use a temprary variable (character_check) for identification of character type
		          if (Character.isUpperCase(character_check))
	               {
		            int k3 = plaintext.charAt(i) - 'A'; 
	//Use k3 variable to hold value of characters in integer
		            int encrypted = (k3 * k1 +k2) % 26; 
	//  Formula according to question "C = (P × k1 + k2) mod 26  k1 + k2) mod 26"
	...
	//  Formula according to question "P = ((C − k2) × k1 k2) × k1 + k2) mod 26  k1− k2) × k1^-1) mod 26"
